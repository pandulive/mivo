...
CameraWindow::CameraWindow()
    : m_VBox(Gtk::ORIENTATION_VERTICAL),
      ...
      m_PauseButton("Pause"),
      m_ZoomButton("Zoom +/-"),
      m_AwbButton("Toggle AWB") {

    set_title("GStreamer Video with AWB");
    ...
    // Enable AWB by default
    g_object_set(source, "white_balance_automatic", TRUE, nullptr);
...
void CameraWindow::on_awb() {
    ...
    if (awb_enabled) {
        ...
        // g_object_set(source, "white_balance_auto", TRUE, nullptr);
        ...
        // set_v4l2_control(cam, V4L2_CID_WHITE_BALANCE_TEMPERATURE, 4660);  // Set color temperature to 4500

        // g_object_set(source, "white_balance_automatic", FALSE, nullptr);
        // g_object_set(source, "white_balance_temperature", 7600, nullptr); // Set temperature to 4600K
        std::cout << "AWB disabled. White balance temperature set to 4600K." << std::endl;
    }
}
...
//     // Toggle AWB
//     awb_enabled = !awb_enabled;
//     g_object_set(source, "white_balance_auto", awb_enabled ? TRUE : FALSE, nullptr);
//     std::cout << "AWB " << (awb_enabled ? "enabled" : "disabled") << std::endl;
// }
